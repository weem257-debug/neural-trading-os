...
# Vendored into the backend deploy context (Railway builds from ./backend).
# Upstream used ``from model.module import *`` with a sys.path hack; here the
# sibling module is imported relatively so the package is self-contained.
from .module import *
