...
export default function InvitePage() {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(76,141,246,0.07) 0%, transparent 70%), #060d1f",
      }}
    >
      {/* Grid overlay */}
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(76,141,246,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(76,141,246,0.04) 1px, transparent 1px)",
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 32px rgba(76,141,246,0.25)",
            }}
          >
            <Cpu className="w-8 h-8" style={{ color: "#4C8DF6", filter: "drop-shadow(0 0 8px rgba(76,141,246,0.8))" }} />
          </div>
          <p className="text-xs tracking-widest font-semibold" style={{ color: "rgba(76,141,246,0.6)" }}>
            NEURAL TRADING OS
          </p>
        </div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 60px rgba(76,141,246,0.06), 0 25px 50px rgba(0,0,0,0.5)",
          }}
        >
          {/* Invite badge */}
          ...
          {referrerName ? (
            <div className="mb-6">
              <h1 className="text-2xl font-black text-white mb-2">
                <span style={{ color: "#4C8DF6" }}>{referrerName}</span> hat dich eingeladen
              </h1>
            ...
            {FEATURES.map(({ icon: Icon, text }) => (
              <li key={text} className="flex items-start gap-3">
                <div
                  ...
                  style={{ background: "rgba(76,141,246,0.08)", border: "1px solid rgba(76,141,246,0.15)" }}
                >
                  <Icon className="w-3.5 h-3.5" style={{ color: "#4C8DF6" }} />
                </div>
          ...
          <Link
            ...
            style={{
              ...
              border: "1px solid rgba(76,141,246,0.5)",
              color: "#4C8DF6",
              boxShadow: "0 0 24px rgba(76,141,246,0.15)",
            }}
          >
