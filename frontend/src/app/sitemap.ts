...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/sentiment`,           lastModified: new Date(), changeFrequency: "daily",   priority: 0.7 },
    { url: `${base}/analysis`,            lastModified: new Date(), changeFrequency: "weekly",  priority: 0.6 },
    { url: `${base}/risk`,                lastModified: new Date(), changeFrequency: "weekly",  priority: 0.6 },
    { url: `${base}/p2p`,                 lastModified: new Date(), changeFrequency: "weekly",  priority: 0.5 },
