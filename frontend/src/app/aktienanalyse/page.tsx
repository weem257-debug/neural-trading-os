...
import type { StockReport, StockVerdikt } from "@/types";
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-5">
        ...
        <GlassCard>
          <div className="space-y-3">
            <div>
              <label className="block text-xs font-semibold tracking-wider mb-2 text-slate-500">
