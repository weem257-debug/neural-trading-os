export default function LandingLoading() {
  return (
    <div className="min-h-screen" style={{ background: "linear-gradient(135deg, #0B0E14 0%, #10141C 50%, #0B0E14 100%)" }}>
      {/* Nav skeleton */}
      <div className="flex items-center justify-between px-6 py-4 max-w-6xl mx-auto">
        <div className="h-5 w-36 rounded animate-pulse" style={{ background: "rgba(76,141,246,0.12)" }} />
        <div className="flex gap-3">
          <div className="h-8 w-20 rounded-lg animate-pulse" style={{ background: "rgba(255,255,255,0.05)" }} />
          <div className="h-8 w-24 rounded-lg animate-pulse" style={{ background: "rgba(76,141,246,0.1)" }} />
        </div>
      </div>

      {/* Hero skeleton */}
      <div className="flex flex-col items-center text-center px-4 pt-16 pb-12 max-w-3xl mx-auto gap-6">
        <div className="h-6 w-48 rounded-full animate-pulse" style={{ background: "rgba(76,141,246,0.1)" }} />
        ...
        <div className="flex gap-3 mt-2">
          <div className="h-12 w-40 rounded-xl animate-pulse" style={{ background: "rgba(76,141,246,0.12)" }} />
      ...
      <div className="flex justify-center gap-8 py-6 max-w-2xl mx-auto px-4">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex flex-col items-center gap-1.5">
            <div className="h-7 w-20 rounded animate-pulse" style={{ background: "rgba(76,141,246,0.1)" }} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto px-6 py-8">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="rounded-2xl p-5 animate-pulse" style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="w-8 h-8 rounded-lg mb-3" style={{ background: "rgba(76,141,246,0.1)" }} />
