    ...
    <div className="space-y-5 animate-pulse">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg" style={{ background: "rgba(163,113,247,0.1)" }} />
            <div className="h-7 w-28 rounded" style={{ background: "rgba(255,255,255,0.06)" }} />
            <div className="h-5 w-24 rounded-full" style={{ background: "rgba(163,113,247,0.08)" }} />
          </div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="h-3 w-16 rounded" style={{ background: "rgba(63,185,80,0.08)" }} />
        </div>
        <div className="h-48 rounded-xl" style={{ background: "rgba(76,141,246,0.04)" }} />
      </div>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="h-5 w-28 rounded-full" style={{ background: "rgba(163,113,247,0.08)" }} />
        </div>
        <div className="space-y-0">
          ...
          {[0, 1, 2, 3, 4].map((i) => (
            ...
            >
              ...
              <div className="h-3 w-16 rounded" style={{ background: "rgba(255,255,255,0.05)" }} />
              <div className="space-y-1">
                <div className="h-3 w-16 rounded" style={{ background: i % 2 === 0 ? "rgba(63,185,80,0.1)" : "rgba(229,83,75,0.1)" }} />
