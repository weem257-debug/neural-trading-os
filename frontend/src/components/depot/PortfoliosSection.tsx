...
/**
 * "Meine Depots" — extracted from the former standalone /portfolios page so
 * it can be embedded as a collapsible section on /depot. Logic, data
 * fetching and hooks are unchanged from the original page; only the export
 * shape changed (named component instead of a page's default export) and
 * the top-level heading was demoted from h1 to h2 since the Collapsible
 * header now carries the section title.
 */
