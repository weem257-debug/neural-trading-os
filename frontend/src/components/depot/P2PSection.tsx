...
/**
 * "P2P Kredite" — extracted from the former standalone /p2p page so it can
 * be embedded as a collapsible section on /depot. Logic, data fetching and
 * hooks are unchanged; only the export shape changed and the top-level
 * heading was demoted from h1 to h2.
 */
