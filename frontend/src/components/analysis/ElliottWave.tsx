...
/**
 * Elliott-Wellen-Analyse — extracted from the former standalone /analysis
 * page so it can be embedded as a collapsible section on /live. Logic is
 * unchanged from the original page; only the export shape changed (named
 * component instead of a page's default export).
 */
...
// ---------------------------------------------------------------------------
// Main component (formerly the /analysis page)
// ---------------------------------------------------------------------------
